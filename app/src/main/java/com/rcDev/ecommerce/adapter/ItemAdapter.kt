package com.rcDev.ecommerce.adapter
...
import kotlinx.android.synthetic.main.ecommerce_item.view.*
...
on 2022-03-24
 */
class ItemAdapter (private val shopItemArrayList: ArrayList<ShopItem>, private val numberOfColumns: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == 0) {
            ...
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ecommerce_item, parent, false)
